...
message(STATUS "Using Android API ${ANDROID_NDK_ANDROID_API}")
message(STATUS "Using Android compiler version ${ANDROID_NDK_COMPILER_VER}")

SET(ANDROID_NDK_TOOLCHAIN_EABI "arm-linux-androideabi-${ANDROID_NDK_COMPILER_VER}" CACHE STRING "Android NDK toolchain")

SET(CMAKE_NDK_SOURCES "${ANDROID_NDK_ROOT}/sources")
SET(CMAKE_NDK_NATIVE_APP_GLUE "${CMAKE_NDK_SOURCES}/android/native_app_glue")
SET(CMAKE_NDK_GNU_LIBSTDC "${CMAKE_NDK_SOURCES}/cxx-stl/gnu-libstdc++/${ANDROID_NDK_COMPILER_VER}")
...
# Linker flags
#
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_NDK_EXE_FLAGS} ${CMAKE_NDK_ALLOW_SHLIB_UNDEF}" CACHE STRING "Executable linker flags")
