...
#ifndef TOWER_ACCESS_SO_H_INCLUDED
#define TOWER_ACCESS_SO_H_INCLUDED
...
class TowerAccessMsgReceiver : public GtfMsgExtReceiver
{
public:
    TowerAccessMsgReceiver();
...
#endif // TOWER_ACCESS_SO_H_INCLUDED
