...
//! @brief ExtOut_Navigation_Select_City
//!
//! Parameters : 1
//! 1) City_Index::int32_t
#define EVENT_GRP_ID_ExtOut_Navigation_Select_City    ((uint32_t) 0x00010000)
#define EVENT_MSG_ID_ExtOut_Navigation_Select_City    ((uint32_t) 0x00000004)
