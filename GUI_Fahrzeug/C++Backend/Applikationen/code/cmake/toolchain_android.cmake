...
SET(ANDROID_NDK_ANDROID_API "android-9" CACHE STRING "Android API level")
SET(ANDROID_NDK_TOOLCHAIN_EABI "arm-linux-androideabi-4.6" CACHE STRING "Android NDK toolchain")

SET(CMAKE_NDK_SOURCES "${ANDROID_NDK_ROOT}/sources")
SET(CMAKE_NDK_NATIVE_APP_GLUE "${CMAKE_NDK_SOURCES}/android/native_app_glue")
SET(CMAKE_NDK_GNU_LIBSTDC "${CMAKE_NDK_SOURCES}/cxx-stl/gnu-libstdc++/4.6")
...
#SET(CMAKE_NDK_INC "${CMAKE_NDK_INC} -I${CMAKE_NDK_GNU_LIBSTDC}/libs/armeabi-v7a/include")
