...
JNIEXPORT void JNICALL Java_com_example_gtflauncher_tower_TowerJNIAccess_onLightStateUpdated
	(JNIEnv *env, jclass cls, jboolean lowBeamIsOn, jboolean highBeamIsOn, jboolean indicatorRightIsOn, jboolean indicatorLeftIsOn)
{
    ...
    if(theObserver)
    {
		theObserver->onLightStateUpdated((bool) lowBeamIsOn, (bool) highBeamIsOn, (bool) indicatorRightIsOn, (bool) indicatorLeftIsOn);
    }
}
