...
//! @brief Type : color
#define DP_ID_Color_Highlight_Gold ((uint32_t) 0x0000005E)

//! @brief Type : color
#define DP_ID_Color_Highlight_Touch ((uint32_t) 0x0000005C)
...
//! @brief Type : string
#define DP_ID_Gesture_Left_Button ((uint32_t) 0x0000002B)

//! @brief Type : string
#define DP_ID_Gesture_Right_Button ((uint32_t) 0x0000002C)

//! @brief Type : string
#define DP_ID_Gesture_UP_Button ((uint32_t) 0x0000002D)
...
//! @brief Type : string
#define DP_ID_MenuItem_Button_Gesture ((uint32_t) 0x0000002E)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Info_Battery ((uint32_t) 0x0000002F)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Info_General ((uint32_t) 0x00000030)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Info_Sponsors ((uint32_t) 0x00000031)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Info_Technical ((uint32_t) 0x00000032)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Information ((uint32_t) 0x00000033)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Media ((uint32_t) 0x00000034)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Navigation ((uint32_t) 0x00000035)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Radio ((uint32_t) 0x00000036)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings ((uint32_t) 0x00000037)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_Appearance ((uint32_t) 0x00000038)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_Language2 ((uint32_t) 0x00000039)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_Rating ((uint32_t) 0x0000003A)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_VehicleMode ((uint32_t) 0x0000003B)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_VehicleMode_Boost ((uint32_t) 0x0000003C)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_VehicleMode_Eco ((uint32_t) 0x0000003D)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_VehicleMode_Recuperation ((uint32_t) 0x0000003E)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Settings_VehicleMode_Sports ((uint32_t) 0x0000003F)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials ((uint32_t) 0x00000040)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_DistanceControl ((uint32_t) 0x00000041)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_Heartbeat ((uint32_t) 0x00000042)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_LED ((uint32_t) 0x00000043)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_LED_Drive ((uint32_t) 0x00000044)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_LED_Rainbow ((uint32_t) 0x00000045)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_LED_Random ((uint32_t) 0x00000046)

//! @brief Type : string
#define DP_ID_MenuItem_Button_Specials_LED_Simulation ((uint32_t) 0x00000047)
...
//! @brief Type : string
#define DP_ID_ViewTitle_BatteryManagement ((uint32_t) 0x00000048)

//! @brief Type : string
#define DP_ID_ViewTitle_Home ((uint32_t) 0x00000049)

//! @brief Type : string
#define DP_ID_ViewTitle_Info_Battery ((uint32_t) 0x0000004A)

//! @brief Type : string
#define DP_ID_ViewTitle_Info_General ((uint32_t) 0x0000004B)

//! @brief Type : string
#define DP_ID_ViewTitle_Info_Sponsors1 ((uint32_t) 0x0000004C)

//! @brief Type : string
#define DP_ID_ViewTitle_Info_Sponsors2 ((uint32_t) 0x0000004D)

//! @brief Type : string
#define DP_ID_ViewTitle_Info_Technical ((uint32_t) 0x0000004E)

//! @brief Type : string
#define DP_ID_ViewTitle_Media ((uint32_t) 0x0000004F)

//! @brief Type : string
#define DP_ID_ViewTitle_Navigation_Map ((uint32_t) 0x00000050)

//! @brief Type : string
#define DP_ID_ViewTitle_Navigation_Search ((uint32_t) 0x00000051)

//! @brief Type : string
#define DP_ID_ViewTitle_Settings ((uint32_t) 0x00000052)

//! @brief Type : string
#define DP_ID_ViewTitle_Settings_Appearance ((uint32_t) 0x00000053)

//! @brief Type : string
#define DP_ID_ViewTitle_Settings_Language ((uint32_t) 0x00000054)

//! @brief Type : string
#define DP_ID_ViewTitle_Settings_Mode ((uint32_t) 0x00000055)

//! @brief Type : string
#define DP_ID_ViewTitle_Settings_Rating ((uint32_t) 0x00000056)

//! @brief Type : string
#define DP_ID_ViewTitle_Specials ((uint32_t) 0x00000057)

//! @brief Type : string
#define DP_ID_ViewTitle_Specials_DistanceControl ((uint32_t) 0x00000058)

//! @brief Type : string
#define DP_ID_ViewTitle_Specials_Gestures ((uint32_t) 0x00000059)

//! @brief Type : string
#define DP_ID_ViewTitle_Specials_Heartbeat ((uint32_t) 0x0000005A)

//! @brief Type : string
#define DP_ID_ViewTitle_Specials_LED ((uint32_t) 0x0000005B)
